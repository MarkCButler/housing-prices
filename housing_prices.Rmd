...
[Ames Housing Dataset](http://www.amstat.org/publications/jse/v19n3/decock.pdf):
  ...
  - A (to-be-determined, probably tree-based) model that aims for predictive accuracy
...
ANOVA ($\eta^2$) is used for nominal predictors.

$R^2$ is used for numeric predictors.
