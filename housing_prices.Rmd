...
### Nominal predictors {.tabset}

#### Summary {.unnumbered}

Certain categories, such as "No Basement", are included in multiple
predictors.  Define a dummy variable for these categories.

  - The "No Basement" category also corresponds to the intercept for some
    numeric variables, such as TotalBsmtSF (Total square feet of basement
    area).  Adding the dummy variable allows the nonzero values of TotalBsmtSF
    to be fit independently of samples with value zero.

Replace nominal variables by numerical rankings in cases where the box plot
has a strongly linear profile.

#### Dummy variables {.tab-display .unnumbered}
